...
**定版**
   ...
   4. 文件工作小組將最新版版號的ARK網址填回文件md檔之「永久統一資源標籤 Persistent URI」欄位。「文件版本控制」章節，加上每個版本，用超連結語法加上URL。
...
flowchart TD
    ...
    subgraph final["3. 定版"]
        ...
        F3 --> F4["文件工作小組將最新版版號的 ARK 網址填回<br/>「永久統一資源標籤 Persistent URI」欄位<br/>並於「文件版本控制」章節<br/>以超連結語法加上每個版本的 URL"]
    end
