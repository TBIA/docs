...
| 紀錄類型      | basisOfRecord                 | 必填    | 清單   | 資料紀錄的特定性質、類型。建議使用 Darwin Core 的控制詞彙。舉例：若為野外調查，則選擇”HumanObservation”(人為觀測)，若為自動相機調查，則選擇”MachineObservation”(機器觀測)，若為二手資料來源，則選擇”MaterialCitation”(引用資料)。                                                                                     | HumanObservation                                                                                                                  |
