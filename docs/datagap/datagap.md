...
### 摘要 Abstract
此文件為TBIA資料空缺工作小組討論、分析並呈現出TBIA入口網 **20231212版本** 整合資料的《TBIA資料空缺概況整理文件》。

在台灣陸地及海域範圍的資料空缺，為夥伴單位提供填補空缺的指引方向。作者兼分析人員首先將資料做了敘述性統計，也在分析資料的過程當中，找出了各夥伴單位所提供的資料裡有問題及有補救機會的地方，希望可以將資料的使用性提高。資料也歸類出不同品質層級的金、銀、銅與未達最低標準資料，希望在不同品質階層的資料可以有一些代表性的資料應用用處。資料空缺主要呈現了時間、空間以及物種類群。時間上，我們目前強調月份上的空缺。空間上，我們分別呈現了1、5、10公里網格的空缺，並會產出空間上有空缺的座標。物種類群上，我們首先列出目前大類群裡資料量佔比較多的排名，並提供可優先填補類群的建議。此外，不同物種類群也有呈現在網格上看空間上的分佈。

讀者如有想要客製化針對某物種類群或某空間等資料做更詳細的分析以取得更符合您需求的資料空缺填補指引，歡迎直接聯繫本文件作者。
...
---
## **1. 資料統計**
這個章節主要描述TBIA入口網裡，尤其是針對台灣範圍內的資料概況做了一些統計。其中一些表格與圖表可以大概看出資料在某比較下的空缺

### 1.1 空間
此文件在空間上的分析。此文件所使用的台灣陸地與海域範圍及網格包含了所有台灣縣市、離島東沙及太平島的海陸範圍（不包含釣魚台）。更多資訊請見附錄一。TBIA入口網裡也包含了不在台灣海陸範圍內的資料，分布圖請見附錄二。
...
### 1.3 物種類群
我們目前先手動挑選了共32個[大類群](https://docs.google.com/spreadsheets/d/1kUkW5CF79zjJmXgb6fz7jGrt1A0JxzC-S1enRVK0bQU/edit?usp=sharing)，先統計出各界與各類群與資料筆數和佔比
...
### 1.4 資料品質
資料應用的過程中會因不同品質等級的資料而影響其適用性。為了呈現出入口網現有的資料品質，我們將資料根據條件歸類出不同品質層級，包括金、銀、銅與未達最低標準資料。表一為資料品質標準定義與該資料筆數。
