# 自動相機資料交換參考模板
作者 - 臺灣生物多樣性資訊聯盟機器觀測資料開放標準工作小組 - tbianoti@gmail.com - version {{ git.short_commit }}, {{ git.date.strftime('%Y-%m-%d %H:%M:%S%z') }} 

---
## **版權說明 Colophon**
### 建議引用方式 Suggested Citation
吳世鴻。2025。自動相機資料交換參考模板。第二版。臺灣生物多樣性資訊聯盟秘書處：臺北。
...
成員（以筆畫順序）：王浥璋<sup>9</sup>、江欣盈<sup>1</sup>、吳俊毅<sup>3</sup>、李金穎<sup>2</sup>、李思賢<sup>2</sup>、李昱<sup>4</sup>、林子皓<sup>2</sup>、林育秀<sup>1</sup>、林峻廷<sup>4</sup>、侯穎霖<sup>6</sup>、姜博仁<sup>4</sup>、柯智仁<sup>2</sup>、洪孝宇<sup>5</sup>、高得愷<sup>2</sup>、張俊怡<sup>2</sup>、張筑竣<sup>2</sup>、許詩涵<sup>6</sup>、陳建文<sup>7</sup>、曾威<sup>8</sup>、黃于禎禧<sup>6</sup>、黃靖倫<sup>3</sup>、劉威廷<sup>6</sup>、劉璟儀<sup>2</sup>
...
| 12     | 關聯多媒體        | associatedMedia | 該筆紀錄關聯的多媒體資源連結網址\(URL\)。                           | 字串     | http\(s\)                                                                      | O       | N          | 若associatedMedia有提供照片，本欄位為必填。控制詞彙詳見附錄「授權標示表」。引用「生物多樣性／生物出現紀錄／紀錄檔案層級／資料授權標示或條款」之欄位。                                                                                                                                                                                                                                                |                                                                  |
...
| 12     | 臺灣物種名錄物種編號   | taxonID                   | 採用臺灣物種名錄（TaiCOL）使用的物種編號（taxon\_id），在 TaiCOL 官網的物種頁面或 API 可取得。                                                                                                     | 字串     |                                                 | O       | 1          | 應與 scientificName （校定物種學名）相互搭配。                             | t0065214                        |
| 13     | 臺灣物種名錄學名編碼   | nameID                    | name\_id，在TaiCOL 學名管理工具或 Api 可取得。                                                                                                                                 | 字串     |                                                 | O       | 1          |                                                             | 74454                           |
| 14     | 臺灣物種名錄學名使用編碼 | usageID                   | usage\_id，在TaiCOL 學名管理工具或 Api 可取得。                                                                                                                                | 字串     |                                                 | O       | 1          |                                                             |                                 |
